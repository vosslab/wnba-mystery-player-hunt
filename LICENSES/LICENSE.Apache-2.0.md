...
(d) If the Work includes a NOTICE text file, You must include a copy of the
attribution notices contained within that NOTICE file.

LIMITATION OF LIABILITY: IN NO EVENT AND UNDER NO LEGAL THEORY SHALL ANY
CONTRIBUTOR BE LIABLE FOR ANY DAMAGES, INCLUDING DIRECT, INDIRECT, SPECIAL,
